...
func Master() {
	...
	flag.BoolVar(&params.Genesis.New, "new-genesis", false, "Created new genesis.")
	flag.IntVar(&params.Genesis.Coint, "new-coint", 100000000, "Number of coins issued: (100000000 or 100000000000)")
	flag.Parse()
